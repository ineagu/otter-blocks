...
/**
 * Custom hook to handle form options
 */
const useFormOptions = (attributes, setAttributes, clientId, name, defaultAttributes) => {
...
/**
 * Custom hook to handle form integration
 */
const useFormIntegration = (attributes, formOptions, setFormOption, setLoading, createNotice) => {
...
const Edit = ({
	...
	const { formOptions, setFormOption, setFormOptionAndSaveUnlock, loadingState, setLoading, saveFormEmailOptions } = useFormOptions(attributes, setAttributes, clientId, name, defaultAttributes);
	const { listIDOptions, setListIDOptions, saveIntegration } = useFormIntegration(attributes, formOptions, setFormOption, setLoading, createNotice);
	...
	const { insertBlock, removeBlock, replaceInnerBlocks, selectBlock, moveBlockToPosition } = useDispatch('core/block-editor');
